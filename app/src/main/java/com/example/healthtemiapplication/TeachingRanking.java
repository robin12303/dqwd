...
public class TeachingRanking extends AppCompatActivity {
    BarChart barChart;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_teaching_ranking);
        ...
        CreateChart(UserList.userList.get(User.rootUser).healthDatas,"deadlift");
    }
