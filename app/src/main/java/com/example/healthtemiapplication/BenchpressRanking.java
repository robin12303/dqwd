...
public class BenchpressRanking extends AppCompatActivity {
    BarChart barChart;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_benchpress_ranking);
        ...
        CreateChart(UserList.userList.get(User.rootUser).healthDatas,"benchpress");
    }
